...
function Cardproduct() {
  return (
    <div className="flex flex-col w-[220px] border-2 border-slate-200 cursor-pointer rounded-md overflow-hidden">
      <div className="w-full h-[180px] bg-gray-500">
        <img src={Thumb} alt="thumbnail product" className="w-full h-full object-cover" />
      </div>
      <div className="flex flex-col p-2">
        <span className="text-lg font-medium">Tas sRotan</span>
